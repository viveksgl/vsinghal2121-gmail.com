...
var TOKEN_DIR = ('E:/vivek new/study tutorials/js tutorial/node.js/NewProject/gmail-api/');
...
function getRecentEmail(auth) {
    ...
    gmail.users.messages.list({auth: auth, userId: 'me', maxResults: 10,}, function(err, response) {
      ...
      console.log('allmegId' + response.data.messages.length)
